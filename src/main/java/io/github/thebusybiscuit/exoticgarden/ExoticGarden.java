...
import dev.cworldstar.utils.SkullCreator;
...
public class ExoticGarden extends JavaPlugin implements SlimefunAddon {
    ...
    private void registerItems() {
        nestedItemGroup = new NestedItemGroup(new NamespacedKey(this, "parent_category"), CustomItemStack.create(SkullCreator.skullFromHash("847d73a91b52393f2c27e453fb89ab3d784054d414e390d58abd22512edd2b"), "&aExotic Garden"));
        mainItemGroup = new SubItemGroup(new NamespacedKey(this, "plants_and_fruits"), nestedItemGroup, CustomItemStack.create(SkullCreator.skullFromHash("a5a5c4a0a16dabc9b1ec72fc83e23ac15d0197de61b138babca7c8a29c820"), "&aExotic Garden - Plants and Fruits"));
        miscItemGroup = new SubItemGroup(new NamespacedKey(this, "misc"), nestedItemGroup, CustomItemStack.create(SkullCreator.skullFromHash("606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131"), "&aExotic Garden - Ingredients and Tools"));
        foodItemGroup = new SubItemGroup(new NamespacedKey(this, "food"), nestedItemGroup, CustomItemStack.create(SkullCreator.skullFromHash("a14216d10714082bbe3f412423e6b19232352f4d64f9aca3913cb46318d3ed"), "&aExotic Garden - Food"));
        drinksItemGroup = new SubItemGroup(new NamespacedKey(this, "drinks"), nestedItemGroup, CustomItemStack.create(SkullCreator.skullFromHash("2a8f1f70e85825607d28edce1a2ad4506e732b4a5345a5ea6e807c4b313e88"), "&aExotic Garden - Drinks"));
        ...
        new SlimefunItem(miscItemGroup, iceCube, RecipeType.GRIND_STONE, new ItemStack[] {new ItemStack(Material.ICE), null, null, null, null, null, null, null, null}, iceCube.asQuantity(4)).register(this);
        ...
        registerMagicalPlant("Gold", SlimefunItems.GOLD_4K.asOne(), "e4df892293a9236f73f48f9efe979fe07dbd91f7b5d239e4acfd394f6eca",
        new ItemStack[] {null, SlimefunItems.GOLD_16K.asOne(), null, SlimefunItems.GOLD_16K.asOne(), getItem("IRON_PLANT"), SlimefunItems.GOLD_16K.asOne(), null, SlimefunItems.GOLD_16K.asOne(), null});

        registerMagicalPlant("Copper", CustomItemStack.create(SlimefunItems.COPPER_DUST.asOne(), 8), "d4fc72f3d5ee66279a45ac9c63ac98969306227c3f4862e9c7c2a4583c097b8a",
        new ItemStack[] {null, SlimefunItems.COPPER_DUST.asOne(), null, SlimefunItems.COPPER_DUST.asOne(), getItem("GOLD_PLANT"), SlimefunItems.COPPER_DUST.asOne(), null, SlimefunItems.COPPER_DUST.asOne(), null});

        registerMagicalPlant("Aluminum", CustomItemStack.create(SlimefunItems.ALUMINUM_DUST.asOne(), 8), "f4455341eaff3cf8fe6e46bdfed8f501b461fb6f6d2fe536be7d2bd90d2088aa",
        new ItemStack[] {null, SlimefunItems.ALUMINUM_DUST.asOne(), null, SlimefunItems.ALUMINUM_DUST.asOne(), getItem("IRON_PLANT"), SlimefunItems.ALUMINUM_DUST.asOne(), null, SlimefunItems.ALUMINUM_DUST.asOne(), null});

        registerMagicalPlant("Tin", CustomItemStack.create(SlimefunItems.TIN_DUST.asOne(), 8), "6efb43ba2fe6959180ee7307f3f054715a34c0a07079ab73712547ffd753dedd",
        new ItemStack[] {null, SlimefunItems.TIN_DUST.asOne(), null, SlimefunItems.TIN_DUST.asOne(), getItem("IRON_PLANT"), SlimefunItems.TIN_DUST.asOne(), null, SlimefunItems.TIN_DUST.asOne(), null});

        registerMagicalPlant("Silver", CustomItemStack.create(SlimefunItems.SILVER_DUST.asOne(), 8), "1dd968b1851aa7160d1cd9db7516a8e1bf7b7405e5245c5338aa895fe585f26c",
        new ItemStack[] {null, SlimefunItems.SILVER_DUST.asOne(), null, SlimefunItems.SILVER_DUST.asOne(), getItem("IRON_PLANT"), SlimefunItems.SILVER_DUST.asOne(), null, SlimefunItems.SILVER_DUST.asOne(), null});

        registerMagicalPlant("Lead", CustomItemStack.create(SlimefunItems.LEAD_DUST.asOne(), 8), "93c3c418039c4b28b0da75a6d9b22712c7015432d4f4226d6cc0a77d54b64178",
        new ItemStack[] {null, SlimefunItems.LEAD_DUST.asOne(), null, SlimefunItems.LEAD_DUST.asOne(), getItem("IRON_PLANT"), SlimefunItems.LEAD_DUST.asOne(), null, SlimefunItems.LEAD_DUST.asOne(), null});
        ...
        items.put("GRASS_SEEDS", grassSeeds.asOne());
    ...
    private void registerTree(String name, String texture, String color, Color pcolor, String juice, boolean pie, Material... soil) {
        ...
        items.put(id + "_SAPLING", sapling.asOne());

        new BonemealableItem(mainItemGroup, sapling, ExoticGardenRecipeTypes.BREAKING_GRASS, new ItemStack[] { null, null, null, null, new ItemStack(Material.TALL_GRASS), null, null, null, null }).register(this);
    ...
    public void registerBerry(String name, ChatColor color, Color potionColor, PlantType type, String texture) {
        ...
        items.put(upperCase + "_BUSH", sfi.asOne());
    ...
    public void registerPlant(String name, ChatColor color, PlantType type, String texture) {
        ...
        items.put(upperCase + "_BUSH", bush.asOne());
    ...
    private void registerMagicalPlant(String name, ItemStack item, String texture, ItemStack[] recipe) {
        ...
        Berry berry = new Berry(essence.asOne(), upperCase + "_ESSENCE", PlantType.ORE_PLANT, texture);
        berries.add(berry);
